...
public class DataAggregationQueries {
	public static final String GET_SIMULATIONS = "SELECT to_jsonb(array_agg(jsonobj.simdata)) " + "FROM simulation s, "
	...
	public static final String GET_SIMULATION_BY_ID = "SELECT jsonb_build_object('id', s.id, "
	...
	public static final String GET_ALL_NODES = "SELECT to_jsonb(array_agg(nodes.data)) " + "FROM node, "
			+ "     LATERAL ( SELECT jsonb_build_object('id', node_id, 'lon', x, 'lat', y) AS data) nodes "
			+ "WHERE sim_id = ?";

	public static final String GET_ALL_EDGES = "SELECT jsonb_agg(ultimateData.line)                    \n"
			+ "FROM (                                         \n"
	...
	public static final String BUSIEST_ROADS_PER_TIME_STEP = "SELECT jsonb_agg(data)                         \n"
			+ "FROM(                                  \n"
