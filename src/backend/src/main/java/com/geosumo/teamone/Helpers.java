...
public class Helpers {
	...
	public synchronized static void processFiles(String simulationName, String simulationDesc, String... files)
	...
	private static int sendFiles(String[] files) throws SQLException, NullPointerException {
		...
		try (PreparedStatement initial = connection.prepareStatement(INSERT)) {
			...
			for (String data : files) {
				...
				if (type == null)
					throw new NullPointerException("Not a valid simulation file");
