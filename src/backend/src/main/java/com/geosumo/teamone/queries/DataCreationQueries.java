...
public class DataCreationQueries {
	...
	public static final String CREATE_SIMULATION = "CREATE TABLE IF NOT EXISTS simulation (                                    \n"
			+ "\tid          SERIAL PRIMARY KEY,                                          \n"
			+ "\tname        TEXT NOT NULL,                                               \n"
			+ "\tupload_date TIMESTAMP DEFAULT current_timestamp,                         \n"
			+ "\tdescription TEXT );\n";

	public static final String CREATE_NODE = "CREATE TABLE IF NOT EXISTS node (                                          \n"
	...
	public static final String CREATE_EDGE = "CREATE TABLE IF NOT EXISTS edge (                                          \n"
			+ "\tsim_id     SERIAL REFERENCES simulation (id) ON DELETE CASCADE NOT NULL, \n"
			...
			+ "\tFOREIGN KEY (sim_id, edge_id) REFERENCES edge (sim_id, edge_id) "
			+ "                                            ON DELETE CASCADE );           \n";
	public static final String CREATE_OUTPUT = "CREATE TABLE IF NOT EXISTS output (                                        \n"
			+ "\tsim_id     SERIAL REFERENCES simulation (id) ON DELETE CASCADE NOT NULL, \n"
	...
	public static final String CREATE = "CREATE SCHEMA IF NOT EXISTS geo_sumo; SET search_path = geo_sumo;\n"
			+ CREATE_USERS + CREATE_SIMULATION + CREATE_NODE + CREATE_ROUTE + CREATE_EDGE + CREATE_OUTPUT;

	public static final String DROP = "DROP TABLE IF EXISTS simulation CASCADE; "
			+ "DROP TABLE IF EXISTS node CASCADE; " + "DROP TABLE IF EXISTS node_tl CASCADE; "
			+ "DROP TABLE IF EXISTS node_data CASCADE; " + "DROP TABLE IF EXISTS roundabout CASCADE; "
			+ "DROP TABLE IF EXISTS route CASCADE; " + "DROP TABLE IF EXISTS edge CASCADE; "
			+ "DROP TABLE IF EXISTS edge_allow CASCADE; " + "DROP TABLE IF EXISTS edge_disallow CASCADE; "
			+ "DROP TABLE IF EXISTS edge_data CASCADE; " + "DROP TABLE IF EXISTS edge_lane CASCADE; "
			+ "DROP TABLE IF EXISTS output CASCADE; " + "DROP TABLE IF EXISTS files CASCADE;";
}
